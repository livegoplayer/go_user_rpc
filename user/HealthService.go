...
import (
	...
	healthgrpc "github.com/livegoplayer/go_user_rpc/user/grpc"
)
...
func (h *HealthImpl) Check(ctx context.Context, req *healthgrpc.HealthCheckRequest) (*healthgrpc.HealthCheckResponse, error) {
...
func (h *HealthImpl) Watch(req *healthgrpc.HealthCheckRequest, w healthgrpc.Health_WatchServer) error {
	return nil
}
